...
lsp.on_attach(function(client, bufnr)
	...
	vim.keymap.set("n", "]d", function() vim.diagnostic.jump({ count = 1, float = true}) end, { buffer = bufnr, remap = false, desc="Diagnostics go next" })
	vim.keymap.set("n", "[d", function() vim.diagnostic.jump({ count = -1, float = true}) end, { buffer = bufnr, remap = false, desc="Diagnostics go prev" })
