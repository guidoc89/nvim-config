...
-- keymap('n', '<leader>gd',vim.cmd.Gdiffsplit)  # -> moved to use diffview instead 
-- keymap('n', '<leader>gll',vim.cmd.Gclog) -- show the logs, but with no file names # -> moved to use diffview instead  
